...
foreach ($lnkPath in $Targets) {
  ...
  $lnk.Description      = 'Parlys - dictee IA (lancement direct, sans console)'
  $lnk.WindowStyle      = 1
  $lnk.Save()
...
Write-Host ""
Write-Host "Done. Click Parlys on the Desktop, the app opens directly without any CMD window."
