...
La dictée vocale — pas la dictée magnétique que vos confrères utilisent depuis 1995, mais la vraie, celle qui reconnaît "lisinopril 10 milligrammes" sans broncher — peut ramener cette charge à **30-45 minutes par jour**. Voici comment choisir l'outil, ce qui change réellement en pratique, et les pièges à éviter.

## Pourquoi la dictée classique (Dragon Medical) perd du terrain

Dragon Medical One domine historiquement le marché. Licence officielle **~699 €/an**, facturée au praticien, avec un dictionnaire de 200 000+ termes médicaux français et des macros "par défaut" pour chaque spécialité. En cabinet, on le retrouve couplé à :
- **Mediclick**, **Crossway**, **Hellodoc** (logiciels de gestion)
- **Doctolib**, **Maiia**, **Keldoc** (agenda en ligne)
- **Lifen** (plateforme de correspondance sécurisée HDS)

Les critiques objectives de Dragon Medical sont connues :
- **Interface Windows 7**. Vraiment. En 2026.
- **Latence de 600-900 ms** sur un i7 moderne, avec un profil utilisateur chargé.
- **Temps d'apprentissage** de 2-3 semaines avant que le profil vocal devienne précis.
- **Crash régulier** après mise à jour Windows — la communauté GitHub compte 400+ issues rapportées.
- **Pas d'app mobile** utilisable.

Les moteurs Whisper fine-tunés en 2024-2025 ont rattrapé Dragon sur le vocabulaire médical français courant. Pour les sous-spécialités très pointues (cardiologie interventionnelle, anatomopathologie), Dragon conserve une avance mesurable mais qui se réduit à chaque itération.

## Les 4 outils sérieux en 2026

### 1. Dragon Medical One — le leader historique

- **Prix** : 699 €/an par utilisateur
- **Accuracy FR médical** : 97-98 % après 2 semaines d'entraînement personnel
- **Latence** : 600-900 ms
- **HDS** : oui (hébergement Nuance Healthcare en Europe)
- **Intégrations** : natif dans Mediclick, Crossway, Hellodoc, Lifen
- **Support FR** : hotline + communauté usager active
...
- **Accuracy FR médical** : 95-96 % en vocabulaire "généraliste" (le dictionnaire médical vertical arrive Q3 2026)
- **Latence** : **< 400 ms voice-to-text** complète
- **Interface** : pastille flottante 176×52 px, transparent, toujours au premier plan
- **Modes** : Raw / Naturel / Formel / Message (idéal pour rédiger un courrier de correspondance propre)
- **HDS** : en cours (certification attendue Q4 2026)
- **Intégrations** : export clipboard + Markdown (s'insère partout), push direct vers Doctolib/Lifen prévu Q3 2026
- **Apprentissage** : zéro — Whisper Turbo généralise dès la première phrase

Verdict : l'alternative la plus sérieuse si vous commencez votre pratique libérale ou si vous cherchez à diviser votre facture Dragon par 6. **Attendre Q3-Q4 2026** si vous êtes dans une spécialité avec jargon dense (radiologie, anapath) pour avoir la vertical médicale certifiée HDS.

### 3. Lifen Dictée

- **Prix** : inclus dans la licence Lifen (~30-60 €/mo selon cabinet)
- **Accuracy** : équivalente à Dragon Medical
- **Spécificité** : sortie directement dans Lifen Courrier (pas besoin de copier-coller)

Verdict : si vous êtes déjà sous Lifen, c'est l'option la plus intégrée. Sinon, le tarif Lifen est élevé pour la dictée seule.

### 4. Spikko / Nuance PowerScribe (radiologie)

Pour les radiologues exclusivement. Moteur ultra-spécialisé sur l'imagerie, intégration native dans PACS. Hors de la course pour le généraliste.
...
|---|---|---|
| Compte-rendu consultation (généraliste) | 8 min | 2 min |
| Courrier de correspondance spécialiste | 12 min | 3-4 min |
| Ordonnance détaillée | 4 min | 1 min |
| Observation médicale (hospitalisation) | 15-20 min | 5-7 min |
| Lettre de sortie | 20 min | 6-8 min |

**Gain moyen** : 65-75 % du temps de rédaction. Sur 18 documents/jour, on parle de **1h45 à 2h15 récupérées**.

Autres bénéfices rapportés (qualitatif) :
- **Moins de douleurs cervicales et des poignets** (TMS récurrent chez les praticiens qui saisissent beaucoup).
- **Plus de regard au patient** : dicter pendant la consultation (à voix haute, avec accord du patient) renforce la relation au lieu de la casser.
- **Compte-rendu plus fidèle** : on dicte à chaud, on oublie moins les détails qu'en reconstituant 4h plus tard le soir.
